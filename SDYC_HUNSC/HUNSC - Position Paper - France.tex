...
\footnotetext[2]{
	...
	\begin{itemize}
		\item Infantry:
		\begin{itemize}
			\item 1x Infantry Regiment (3x Infantry Battalions), Reinforced (approx. 3,500 - 4,000 personnel)
			\item 3,000x M1 Garand Rifles
			\item 1,200x M1 Carbines
			\item 300x M1918 Browning Automatic Rifles (BAR)
			\item 150x M1919 Browning Machine Guns
			\item 90x M2 Mortars
			\item 60x M9 Bazookas
			\item 50x M2 Heavy Browning Machine Guns
		...
		\item Cavalry:
		\begin{itemize}
			\item 1x Cavalry Troop (approx. 200 - 250 personnel)
...
\footnotetext[2]{
	...
	\begin{itemize}
		\item 1x Logistics Battalion (approx. 1,200 - 1,400 personnel)
				\begin{itemize}
					\item Motor Transport Company: 50x 2.5-ton trucks, 20x 5-ton trucks
					\item Engineer Company: For construction and repair of roads, bridges, and other infrastructure
					\item Medical Company: For the provision of medical services and support to the QRF (i.e. field hospitals, medical evacuation)
					\item Ordnance Company: For the maintenance and repair of weapons, vehicles, and equipment
					\item Supply Company: For the management of food, water, ammunition, and other supplies
				\end{itemize}
	\end{itemize}
